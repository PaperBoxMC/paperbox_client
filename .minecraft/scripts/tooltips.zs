...
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:advanced_interpreter"}).addTooltip("§3Rank: §d§lA");
...
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:eco-t7"}).addTooltip("§3Rank: §d§lA+%");
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:eco-t7"}).addTooltip("§dECO实验室新作品");
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:eco-t7"}).addTooltip("§b结合Mana收集器并使用水晶矩阵会放大Mana收集器的范围");
...
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:ultimate_zhongzi"}).addTooltip("§3Rank: §d§lA");

<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:biomass/biogas_generator"}).addTooltip("§3Rank: §a§lC - §b§lB");
...
<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:mana_collector"}).addTooltip("§3Rank: §d§lA-");
